  ...
  if (cartItems.length === 0) {
    return (
      <View className="flex-1 bg-white p-6">
        <Text className="text-2xl font-bold text-green-600 mb-6">My Cart</Text>
        <View className="flex-1 justify-center items-center">
          <Text className="text-6xl mb-4">🛒</Text>
          <Text className="text-xl text-gray-600 mb-2">Your cart is empty</Text>
      ...
      <ScrollView className="p-6">
        ...
        <View className="bg-green-50 rounded-2xl p-6 mt-4">
          ...
          <View className="flex-row justify-between mb-2">
            ...
            <Text className="text-gray-800">P{getTotalPrice().toFixed(2)}</Text>
          </View>
